...
public class ExempleComprendre {
	...
	public static void main(String[] args) {
		...
		p1.setY(10);
		afficher("p1", p1);
										// Dessiner l'état de la mémoire (0, 10)
		...
		afficher("p1", p1);		// Qu'est ce qui est affiché ? (100, 110)
										...
										// Dessiner l'état de la mémoire p1 et p3 pointent vers le même objet
		...
		p1 = p2 = p3;
										// Dessiner l'état de la mémoire les 3 poignées pointent vers le même objet Point qui était celui de p3
		...
		System.out.println("d = " + d);
							...
							// Combien y a-t-il de points accessibles ? 1
	}
}
